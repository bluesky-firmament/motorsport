...
def plot(drivername,driver_lap,lap_number,round,race,iteration):
    ...
    try:
        ...
        plt.text(20, 145 - iteration * 4, formula, size=10)
        plt.ylim(100.0,120.0)
        figure_name = "Rd" + str(round) + "/Race" + race + "/" + "Drivers_Race" + race + "_RacePace.png"
